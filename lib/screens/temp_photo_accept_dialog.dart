  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      content: Form(
        key: _formKey,
        child: Column(
          mainAxisSize: MainAxisSize.min, // ให้หดขนาดหน้าต่างตามคอนเทนต์แบบ Modal
          children: [
            ...
            TextFormField(
              ...
              inputFormatters: [
                FilteringTextInputFormatter.digitsOnly, // พิมพ์ตัวอักษรไม่ขึ้นแน่นอน!
              ],
              ...
              validator: (value) {
                if (value == null || value.trim().isEmpty) return '❌ กรุณาใส่เลขครุภัณฑ์';
                if (value.trim().length != 12) return '❌ เลขครุภัณฑ์ต้องมีความยาว 12 หลัก';
                return null;
              },
            ),
          ],
